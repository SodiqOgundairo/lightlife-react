...
const Home = () => {
  return (
    <main className=" flex flex-col">
      <div className="md:px-8 lg:px-36 px-2 flex flex-col gap-7 bg-no-repeat pt-4 md:pt-40 pb-4 md:pb-20 items-center heroBg justify-center min-h-screen text-center">
