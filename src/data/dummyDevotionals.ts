...
export const DUMMY_DEVOTIONALS: DevotionalEntry[] = [
  {
    ...
    action_category: 'Prayer',
    action_content: 'Lord, increase our faith. Help us to trust in Your promises and walk boldly in the path You have set before us. Amen.',
  ...
  },
  {
    ...
    action_category: 'Prayer',
    action_content: 'Father, teach us to pray with sincerity and persistence. May our prayers be pleasing to You and bring about Your will on earth. Amen.',
    bible_reading_plan_text: 'Genesis 4-6, Matthew 2',
  },
  {
    id: '3',
    entry_date: '2025-04-03', // Matching the date from the original DLD.tsx for easy comparison
    ...
    action_category: 'Prayer',
    action_content: 'Heavenly Father, thank You for the promise of heaven. Thank You for preparing a place for us where we will experience Your presence in fullness. Help us to live with an eternal perspective, remembering that this world is not our home. Strengthen our faith and help us to share the hope of heaven with others. Thank You for the gift of eternal life through Jesus. In His name, Amen.',
