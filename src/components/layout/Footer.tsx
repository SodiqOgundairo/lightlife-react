  ...
  return (
    <footer className="flex flex-col px-8 md:px-8 lg:px-36 py-10 gap-7 md:py-20 bg-darkPurple text-light">
      <div className="flex flex-col md:flex-row justify-between md:items-start gap-7 ">
        ...
        <div className="flex flex-col gap-15 flex-1 text-sm">
          <div className="flex flex-col flex-start gap-5 flex-1">
            ...
            <a
              href="tel:+234816527103"
              className="hover:text-gold hover:scale-105 hover:underline transition-all ease-linear flex items-center gap-2"
            >
              {" "}
              <LuPhone /> +234(0)-816-527-103
            </a>

            <a
              href="mailto:info@lightlifechurch.com"
              className="hover:text-gold hover:scale-105 hover:underline transition-all ease-linear flex items-center gap-2"
            >
              {" "}
              <LuMail /> info@lightlifechurch.com
            </a>
          </div>
          ...
          <div className="flex flex-col flex-start gap-5 flex-1">
            ...
            <div className="flex gap-7 text-lg items-center">
              <a
                href="https://web.facebook.com/LightLifeChurchNG/?_rdc=1&_rdr"
                className="hover:text-gold hover:scale-105 hover:underline transition-all ease-linear flex items-center gap-2"
              >
                {" "}
                <LuFacebook />
              ...
              <a
                href="https://www.youtube.com/@lightlifechurch"
                className="hover:text-gold hover:scale-105 hover:underline transition-all ease-linear flex items-center gap-2"
              >
                {" "}
                <LuYoutube />
              ...
              <a
                href="https://www.instagram.com/lightlifechurch/"
                className="hover:text-gold hover:scale-105 hover:underline transition-all ease-linear flex items-center gap-2"
              >
                {" "}
                <LuInstagram />
              ...
              <a
                href="https://www.tiktok.com/@lightlifechurch"
                className="hover:text-gold hover:scale-105 hover:underline transition-all ease-linear flex items-center gap-2"
              >
                {" "}
                <PiTiktokLogoLight />
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-5 mt-10">
        <div className="flex flex-col gap-3">
          <small>
            ...
            <a
              ...
              className="italic font-semibold hover:text-gold hover:scale-105 hover:underline transition-all ease-linear"
              target="_blank"
              rel="noopener"
            >
              {" "}
        ...
        <small className="">{copyrightText}</small>
      </div>
    </footer>
  )
}
